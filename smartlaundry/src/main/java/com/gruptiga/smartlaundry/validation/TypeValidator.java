...
public class TypeValidator {
    ...
    public void validateCreateTypeRequest(TypeRequest typeRequest,Type type) {
        ...
        boolean exists = typeRepository.existsByNameAndAccount(type.getName(), type.getAccount());
        if (exists) {
